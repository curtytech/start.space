...
// Toggle do menu de apps (grade 3x3)
(function() {
const btn = document.getElementById('google-apps-btn');
const menu = document.getElementById('google-apps-menu');
if (!btn || !menu) return;
...
// "Estou com sorte" (btnI=1) abre o primeiro resultado em nova aba
...
if (!q.trim()) return;
const url = 'https://www.google.com/search?q=' + encodeURIComponent(q) + '&btnI=1';
window.open(url, '_blank', 'noopener,noreferrer');
});

// Ctrl+K/Cmd+K foca no campo de pesquisa
document.addEventListener('keydown', function(e) {
if ((e.ctrlKey || e.metaKey) && e.key === 'k') {
e.preventDefault();
const input = document.getElementById('google-search-input');
